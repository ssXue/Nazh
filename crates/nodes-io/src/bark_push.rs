...
fn validate_bark_response(status_code: u16, response_value: &Value) -> Result<(), String> {
    if status_code >= 400 {
        return Err(format!(
...
fn build_bark_metadata(params: &BarkMetadataParams<'_>) -> serde_json::Map<String, Value> {
