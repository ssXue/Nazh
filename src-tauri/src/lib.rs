...
pub fn run() {
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::devices::assets::load_device_asset,
            commands::devices::assets::save_device_asset,
            commands::devices::assets::delete_device_asset,
            commands::devices::versions::list_asset_versions,
            commands::devices::versions::load_asset_version,
            commands::devices::snapshots::list_device_snapshots,
            commands::devices::snapshots::create_device_snapshot,
            commands::devices::snapshots::rollback_device_snapshot,
            commands::devices::snapshots::delete_device_snapshot,
            commands::devices::fields::patch_device_field,
            commands::devices::fields::bind_device_connection,
            commands::devices::fields::add_device_signal,
            commands::devices::fields::remove_device_signal,
            commands::devices::fields::add_device_alarm,
            commands::devices::fields::remove_device_alarm,
            commands::devices::fields::generate_pin_schema,
            commands::devices::fields::save_device_asset_sources,
            commands::devices::fields::load_device_asset_sources,
