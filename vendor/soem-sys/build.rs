...
#endif
"#;
    fs::write(out_dir.join("soem/ec_options.h"), options_h).expect("无法写入 ec_options.h");
    fs::write(soem_subdir.join("ec_options.h"), options_h).expect("无法写入 soem/ec_options.h");
}
